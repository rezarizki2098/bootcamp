...
app.get("/r/:subreddit", (req, res) => {
  ...
  const data = redditData[subreddit]; //? ini digunakan untuk mengambil variable object yang banyak data
  console.log(data);
  if (data) {
    res.render("subreddit", { ...data }); //? subreddit adalah path, sedangkan ...data untuk isi data
  } else {
    res.render("notfound", { subreddit }); //? subreddit adalah path, sedangkan {subreddit} nama url yg diambil dari variable const {subreddit}
  }
});
